  ...
  createDb() {
    ...
    const dishes = [
      ...
      },
      {
        id: 38,
        menu: 4,
        name: 'Light foie gras paste with crispy toast',
        price: 3150,
        imageUrl: 'https://delivery.pgr.kz/image/cache/catalog/Crudo/crudo/holod/legkijpashtetizfua-grashrustyaschimitostami-0x430.jpg',
        description: 'foie gras, ciabatta, berry confit',
        count: 1
      },
      {
        id: 39,
      ...
      },
      {
        ...
        name: 'Bowl Salad',
        price: 2980,
        imageUrl: 'https://delivery.pgr.kz/image/cache/catalog/Crudo/01_Boul_salat_s_govadino_i_bulgurom-0x430.jpg',
        description: 'Bowl Salad with Beef and Bulgur',
        count: 1
      },
      {
        id: 42,
        ...
        name: 'Greek salad',
        price: 3360,
        imageUrl: 'https://delivery.pgr.kz/image/cache/catalog/Mediterranean/grecheskijsalat(2)-0x430.jpg',
        description: 'tomato, cucumber, sweet pepper, Feta cheese, onion, olive oil, Kalamata olives, lettuce, Citronette dressing',
        count: 1
      },
      {
        id: 43,
        menu: 5,
        name: 'Rocket & Shrimp salad',
        price: 5180,
        imageUrl: 'https://delivery.pgr.kz/image/cache/catalog/Mediterranean/Salatsrukkolojikrevetkami(2)-0x430.jpg',
        description: 'rocket, avocado, tomato, shrimp, parmesan, dressing, balsamic reduction',
        count: 1
      },
      {
        id: 44,
        ...
        name: 'Warm salad',
        price: 5240,
        imageUrl: 'https://delivery.pgr.kz/image/cache/catalog/Olivier/new/Teplijsalatslososemitomatnojzapravkoj-0x430.jpg',
        description: 'Warm salad with salmon and tomato dressing',
        count: 1
      },
      {
        id: 45,
        ...
        price: 3560,
        imageUrl: 'https://delivery.pgr.kz/image/cache/catalog/Dostavka/thumb_258_375x282_0_0_crop-0x430.jpg',
        description: 'Salad with tofu',
        count: 1
      },
      {
        id: 51,
        menu: 6,
        name: 'Soup with sunroot, smoked duck and pear',
        price: 3420,
        imageUrl: 'https://delivery.pgr.kz/image/cache/catalog/Olivier/new/776A3588-0x430.jpg',
        description: 'Soup with sunroot, smoked duck and pear',
        count: 1
      },
      {
        id: 52,
        menu: 6,
        name: 'Traditional Tom-yum with coconut milk',
        price: 4220,
        imageUrl: 'https://delivery.pgr.kz/image/cache/catalog/Olivier/olive/TradicionnijTomYAmnakokosovommoloke-min-0x430.jpg',
        description: 'Traditional Tom-yum with coconut milk',
        count: 1
      },
      {
        id: 53,
        ...
        name: 'Moscow borsch',
        price: 3240,
        imageUrl: 'https://delivery.pgr.kz/image/cache/catalog/Olivier/olive/BorschMoskovskij-min-0x430.jpg',
        description: 'Moscow borsch',
        count: 1
      },
      {
        id: 54,
        menu: 6,
        name: 'Cream of porcini mushroom soup',
        price: 2940,
        imageUrl: 'https://delivery.pgr.kz/image/cache/catalog/Olivier/olive/Krem-supizbelihgribov-min-0x430.jpg',
      ...
      },
      {
        ...
        name: 'Noodle Soup',
        price: 2960,
        imageUrl: 'https://delivery.pgr.kz/image/cache/catalog/Olivier/olive/Sup-lapshaskuricej-min-0x430.jpg',
      ...
      },
      {
        ...
        name: 'The kings ear',
        price: 90,
        imageUrl: 'https://delivery.pgr.kz/image/cache/catalog/Dostavka/thumb_167_375x282_0_0_crop-0x430.jpg',
        description: 'The kings ear',
        count: 1
      },
      { id: 61,
        menu: 7,
